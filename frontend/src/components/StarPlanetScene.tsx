...
export function StarPlanetScene() {
  ...
  useEffect(() => {
    ...
    function animate(time: number) {
      ...
      group.rotation.y = smoothPointerX * 0.16 + Math.sin(seconds * 0.18) * 0.075;
      group.rotation.x = -smoothPointerY * 0.1 + Math.sin(seconds * 0.22) * 0.028;
      group.position.z = Math.sin(seconds * 0.2) * 0.22;
      planet.rotation.y = seconds * 0.26;
      planet.rotation.x = Math.sin(seconds * 0.25) * 0.14;
      planet.rotation.z = Math.sin(seconds * 0.2) * 0.035;
      wire.rotation.y = seconds * 0.13;
      core.rotation.y = seconds * 0.7;
      core.rotation.z = seconds * 0.35;
      ring.rotation.x = 1.22 + Math.sin(seconds * 0.22) * 0.035;
      ring.rotation.z = -0.38 + Math.sin(seconds * 0.35) * 0.065;
      ringGlow.rotation.copy(ring.rotation);
      particles.rotation.y = seconds * 0.085;
      particles.rotation.x = Math.sin(seconds * 0.16) * 0.07;
