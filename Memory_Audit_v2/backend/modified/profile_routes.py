...
from app.services.audit import diff_before_after, snapshot_entity, write_audit_event
...
def update_profile(
    ...
    changed = diff_before_after(before, snapshot_entity(profile))
    if changed:
        write_audit_event(
            db,
            ...
            severity="warning",
            action=f"Profile fields manually edited: {changed}",
